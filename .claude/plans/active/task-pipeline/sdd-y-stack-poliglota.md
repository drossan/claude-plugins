...
- [x] `task-pipeline-sdd-y-stack-poliglota-05` (P1) — Flag `features.sdd` **booleano** (opt-in, default off, fuera de preset, ausencia ≠ drift) en todas las sedes del schema  · depends_on: task-pipeline-sdd-y-stack-poliglota-04
